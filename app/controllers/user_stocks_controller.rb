class UserStocksController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_stock.save
        format.html { redirect_to my_porfolio_path, notice: 'Stock #{@user_stock.stock.ticker} stock was successfully added.' }
  ...
  def destroy
    @user_stock.destroy
    respond_to do |format|
      format.html { redirect_to user_stocks_url, notice: 'Stock was successfully removed from porfolio.' }
